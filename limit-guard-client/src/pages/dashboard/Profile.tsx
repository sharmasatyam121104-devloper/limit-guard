...
const Profile = () => {
  ...
  const [fullname, setFullname] = useState("username1");
        ...
        <div className="flex justify-between items-end mb-6">
          ...
          {!isEditing ? (
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => setIsEditing(false)} className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition text-sm font-semibold shadow-md shadow-indigo-200">
        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 md:p-10">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            <div className="relative group mb-4">
              ...
              {isEditing && (
                <button className="absolute bottom-0 right-0 p-3 bg-white border border-gray-200 rounded-full shadow-lg text-gray-600 hover:scale-105 transition">
                  <Camera size={18} />
                </button>
              )}
            </div>
          ...
          <div className="space-y-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                disabled={!isEditing}
                className={`w-full px-4 py-3 rounded-xl border ${isEditing ? "border-indigo-300 ring-4 ring-indigo-50" : "border-gray-200 bg-gray-50"} transition-all outline-none`}
              />
            </div>
